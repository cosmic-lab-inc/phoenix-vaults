...
use crate::state::{Investor, MarketRegistry, PhoenixProgram, Vault};
...
pub fn market_deposit<'c: 'info, 'info>(
    ...
    ctx.phoenix_deposit(DepositParams {
        quote_lots_to_deposit: quote_lots,
        base_lots_to_deposit: base_lots,
    })?;
